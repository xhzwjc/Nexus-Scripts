...
ROLE_DEFINITIONS: Tuple[RoleDefinition, ...] = (
    ...
    RoleDefinition("product-manager", "产品经理", "负责跨模块跟进与业务观察，可查看平台状态但不直接管理资源", 70, ("settlement", "commission", "balance", "task-automation", "tax-reporting", "tax-calculation", "settlement-sim", "payment-stats", "delivery-tool", "ocr-tool", "cert-health", "server-monitoring", "team-resources", "ai-resources", "agent-chat", "recruitment-dashboard-view", "recruitment-log-view", "recruitment-review-view", "recruitment-skill-view", "recruitment-mail-view"), "home"),
    ...
    RoleDefinition("auditor", "审计/只读", "用于只读检查与巡视，避免执行写操作", 90, ("payment-stats", "team-resources", "ai-resources", "cert-health", "server-monitoring", "audit-log-view", "recruitment-dashboard-view", "recruitment-log-view", "recruitment-review-view"), "home"),
)
