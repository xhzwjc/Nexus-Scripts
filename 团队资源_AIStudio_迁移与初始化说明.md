...
3. 在新 Mac 上只初始化团队资源、AI Studio、AI 招聘基础库，以及最小用户 / 角色 / 密钥
...
- `admin`：全权限
- `resource_manager`：团队资源 + AI Studio 管理
- `recruitment_operator`：AI 招聘工作台访问
...
这个文件包含明文密钥，已被 `.gitignore` 忽略，不要提交。
...
第一条适合“先补团队资源”，第二条适合“把团队资源和 AI Studio 一次性都回写出来”。
...
- `admin` 能访问全部页面
- `resource_manager` 能管理团队资源和 AI Studio
- `recruitment_operator` 能进入 AI 招聘页面
