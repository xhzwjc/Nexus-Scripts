...
export interface WorkspacePageProps {
    ...
    todoSummary: { pendingPublish: number; pendingInterview: number; pendingDecision: number };
    ...
    labelForCandidateStatus: (status: string) => string;
}
                ...
                <Card className={panelClass}>
                    ...
                    <CardContent className="grid gap-3 pt-2 sm:grid-cols-2 2xl:grid-cols-3">
                        <QuickActionCard title="新建岗位" description="录入岗位并进入详情工作区" icon={Plus}
                                         onClick={openCreatePosition}/>
                        <QuickActionCard title="生成 JD" description="直接跳到当前岗位的 JD 工作区" icon={Sparkles}
