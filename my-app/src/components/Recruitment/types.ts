...
const zhRecruitmentLocale: RecruitmentLocaleBundle = {
    pageMeta: {
        ...
        assistant: {
            title: "招聘助手",
            description: "把岗位上下文、启用评估方案和自然语言操作收拢到显眼且高频可用的工作区。",
        },
        "settings-skills": {
            title: "招聘评估方案管理",
            description: "评估方案是管理员配置项，因此入口隐藏在管理设置中，不占用主工作流视线。",
        },
        "settings-models": {
            title: "模型配置中心",
    ...
    candidateStatusLabels: {
        ...
        interview_first_pending: "初试未处理",
        interview_first_active: "初试进行中",
        interview_first_rejected: "初试淘汰",
        interview_second_pending: "复试未处理",
        interview_second_active: "复试进行中",
        interview_second_rejected: "复试淘汰",
    ...
    toast: {
        ...
        noScreeningQueued: "没有成功入队任何初筛任务，请检查候选人是否已关联岗位且岗位已绑定初筛评估方案",
        ...
        skillEnabled: "评估方案已启用",
        skillDisabled: "评估方案已停用",
...
const enRecruitmentLocale: RecruitmentLocaleBundle = {
    pageMeta: {
        ...
        assistant: {
            ...
            description: "Bring position context, enabled assessment plans, and natural language operations into one high-frequency workspace.",
        },
        "settings-skills": {
            title: "Assessment Plan Settings",
            description: "Manage assessment plans in the admin settings area without crowding the primary workflow.",
        },
        "settings-models": {
    ...
    candidateStatusLabels: {
        ...
        interview_first_pending: "First Pending",
        interview_first_active: "First Active",
        interview_first_rejected: "First Rejected",
        interview_second_pending: "Second Pending",
        interview_second_active: "Second Active",
        interview_second_rejected: "Second Rejected",
    ...
    toast: {
        ...
        noScreeningQueued: "No screening tasks were queued successfully. Please check if candidates are linked to a position and the position has screening assessment plans bound.",
        ...
        skillEnabled: "Assessment plan enabled",
        skillDisabled: "Assessment plan disabled",
