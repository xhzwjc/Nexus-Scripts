        ...
        <div className="size-full flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100">
            <div className="text-center space-y-6 px-8 animate-[fadeIn_0.8s_ease-out]">
                <div className="space-y-3">
                    <h1 className="text-6xl tracking-tight text-slate-900">
                        欢迎
                    </h1>
                ...
                <button
                    ...
                    className="mt-8 px-8 py-3 bg-slate-900 text-white rounded-full hover:bg-slate-800 transition-colors duration-300"
                >
                    开始探索
                </button>
            </div>
